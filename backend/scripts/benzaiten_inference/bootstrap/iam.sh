...
DEFAULT_BACKEND_GCP_SERVICE_ACCOUNT_EMAIL="github-actions-sa@${PROJECT_ID}.iam.gserviceaccount.com"
BACKEND_GCP_SERVICE_ACCOUNT_EMAIL="${BACKEND_GCP_SERVICE_ACCOUNT_EMAIL:-${DEFAULT_BACKEND_GCP_SERVICE_ACCOUNT_EMAIL}}"
